  ...
  return (
    <header className="flex justify-between px-4 py-4">
      <div className="flex gap-3">
        ...
        <h1 className="text-primary text-2xl">Vinylo</h1>
      </div>
      <div className="flex gap-4 px-2">
        <button className="bg-strong text-white px-4 sm:px-8 py-2 rounded-md border-2 border-light hover:bg-violetneon" onClick={gotoLogin}>Sign in</button>
