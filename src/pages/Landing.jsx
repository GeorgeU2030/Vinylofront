  ...
  return (
    <div className="h-screen w-screen flex flex-col">
      ...
      <section className="flex flex-col items-center w-full">
        ...
        <h1 className="text-primary mt-6 text-lg font-normal">Discover and rate the music you love with Vinylo 🎵</h1>
      ...
      <section className="flex flex-col items-center w-full">
        ...
        <h1 className="text-light text-lg font-normal mt-6">Your artists, your champions 🏆</h1>
